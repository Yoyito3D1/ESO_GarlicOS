...
_ga_clear:
	...
	@;Resultat:
	@; R0: 0 si està ocupat, 1 si ha entrat ara en BLK, 2 si fora de rang
_ga_wait:
    push {lr}         
	cmp r0, #8				@; Si està fora de rang guardem 2 a r0 i sortim
	blo .LferWait
	mov r0, #2
	b .LforaRangW
.LferWait:
	bl _gp_wait				@; Si està dins del rang cridem _gp_wait
.LforaRangW:
    pop {pc}        
	...
	.global _ga_signal
	@;Paràmetres:
	@; R0: índex del semàfor a fer signal
	@;Resultat:
	@; R0: 0 si està ocupat, 1 si ha sortit ara de BLK, 2 si fora de rang
_ga_signal:
    push {lr}         
	cmp r0, #8				@; Si està fora de rang guardem 2 a r0 i sortim
	blo .LferSignal
	...
	b .LforaRangS
.LferSignal:
	bl _gp_signal			@; Si està dins del rang cridem _gp_signal
.LforaRangS:
    pop {pc}        
